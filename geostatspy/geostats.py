...
def declus(df, xcol, ycol, vcol, iminmax, noff, ncell, cmin, cmax):
    ...
    :type cmax: float
    :return: list containing a np array of optimal declustering weights(one
             weight(type: float) for each row in df), a np array of declustered
             means for each of the ncell cells, and a np array of the cell
             sizes of each of the ncell cells
     type return: list (of 3 np arrays)
    """
